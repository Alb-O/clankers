...
//! Clankers is a Rust library for building LLM-powered applications that focuses on ergonomics and modularity.
//!
//! # Table of contents
...
//! # Simple example:
//! ```
//! use clankers::{client::CompletionClient, completion::Prompt, providers::openai};
//!
//! #[tokio::main]
//! async fn main() {
...
//! Clankers provides a consistent API for working with LLMs and embeddings. Specifically,
...
//!
//! ## Agents
//! Clankers also provides high-level abstractions over LLMs in the form of the [Agent](crate::agent::Agent) type.
//!
...
//! Clankers provides a common interface for working with vector stores and indexes. Specifically, the library
...
//! # Integrations
//! ## Model Providers
//! Clankers natively supports the following completion and embedding model provider integrations:
//! - Anthropic
//! - Azure
//! - Cohere
//! - Deepseek
...
pub use clankers_derive::{Embed, clankers_tool as tool_macro};
