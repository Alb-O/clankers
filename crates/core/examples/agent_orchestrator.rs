...
async fn main() -> Result<(), anyhow::Error> {
	...
	let classify_agent = openai_client.extractor::<Specification>(openai::completion::types::GPT_4)
        .preamble("
	...
	let content_agent = openai_client
		.extractor::<TaskResults>(openai::completion::types::GPT_4)
		.preamble(
			"
	...
	let judge_agent = openai_client
		.extractor::<Specification>(openai::completion::types::GPT_4)
		.preamble(
			"
